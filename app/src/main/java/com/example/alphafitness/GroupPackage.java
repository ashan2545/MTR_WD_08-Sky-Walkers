...
public class GroupPackage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSche = findViewById(R.id.txtGs);
        txtTrai = findViewById(R.id.txtGt);
        txtPay = findViewById(R.id.txtGp);
    ...
    private void Save() {
        ...
        dbRef = FirebaseDatabase.getInstance().getReference().child("Group package");
        try {
    ...
    public void Edit() {
        ...
        Query updateQuery = dbRef.child("Group package").orderByChild("SID").equalTo(txtid.getText().toString().trim());
    ...
    public void Delete() {
        dbRef = FirebaseDatabase.getInstance().getReference();
        Query deleteQuery = dbRef.child("Group package").orderByChild("SID").equalTo(txtid.getText().toString().trim());
    ...
    public void View() {
        ...
        Query readRef = FirebaseDatabase.getInstance().getReference().child("Group package").orderByChild("SID").equalTo(txtid.getText().toString().trim());
