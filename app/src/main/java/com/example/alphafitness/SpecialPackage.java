...
public class SpecialPackage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSche = findViewById(R.id.txtSs);
        txtTrai = findViewById(R.id.txtSt);
        txtPay = findViewById(R.id.txtSp);
        txtid = findViewById(R.id.txtGid);
    ...
    private void Save() {
        ...
        dbRef = FirebaseDatabase.getInstance().getReference().child("Special package");
        try {
    ...
    public void Edit() {
        ...
        Query updateQuery = dbRef.child("Special package").orderByChild("SID").equalTo(txtid.getText().toString().trim());
    ...
    public void Delete() {
        dbRef = FirebaseDatabase.getInstance().getReference();
        Query deleteQuery = dbRef.child("Special package").orderByChild("SID").equalTo(txtid.getText().toString().trim());
    ...
    public void View()
    {
        ...
        Query readRef = FirebaseDatabase.getInstance().getReference().child("Special package").orderByChild("SID").equalTo(txtid.getText().toString().trim());
